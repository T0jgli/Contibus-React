...
const Formoffer = () => {
    ...
    const formofferref = useRef(null)
    ...
    const handlesubmit = (e) => {
        ...
        if (accept) {
            ...
            db.collection("formofferusers").add({
                ...
                indulas: state.indulas,
                erkezes: state.erkezes,
                seat: state.seat,
                    ...
                    <MDBCol className="mb-4 card pr-0 pl-0 rounded" style={{ backgroundColor: "rgb(250, 250, 250)" }}>
                        <MDBCardHeader className="unique-color-dark roundedimg white-text text-center py-4">
                            <ScrollAnimation animateIn="fadeInDown" animateOnce offset={window.innerHeight}>
                                <h4 className="mb-0"><MDBIcon icon="caret-down" className="px-2" />{language === "eng" ? ("BUS OFFER REQUEST") : ("AUTÓBUSZ AJÁNLAT KÉRÉS")}<MDBIcon className="px-2" icon="caret-down" /></h4>
                            </ScrollAnimation>
                        </MDBCardHeader>

                        <MDBCardBody className="rounded">
                            <form ref={formofferref} onSubmit={handlesubmit}>
                                <ScrollAnimation animateIn="fadeIn" animateOnce offset={window.innerHeight}>
                                    <div className="form-row my-3">
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="name">{language === "eng" ? ("Customer name *") : ("Megrendelő neve *")}</label>
                                            <input type="text" name="name"
                                                className="form-control z-depth-1" required value={state.name} onChange={e => setstate({ ...state, name: e.target.value })} />
                                        </MDBCol>
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="phone">{language === "eng" ? ("Phone number *") : ("Telefonszám *")}</label>
                                ...
                                <ScrollAnimation animateIn="fadeIn" animateOnce offset={window.innerHeight}>
                                    <div className="form-row my-3">
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="email">{language === "eng" ? ("Email address *") : ("Email cím *")}</label>
                                ...
                                <ScrollAnimation animateIn="fadeIn" animateOnce offset={window.innerHeight}>
                                    <div className="form-row my-3">
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="uticel">{language === "eng" ? ("Destination *") : ("Úticél *")}</label>
                                        ...
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="km">{language === "eng" ? ("Planned budget *") : ("Tervezett költségkeret *")}</label>
                                ...
                                <ScrollAnimation animateIn="fadeIn" animateOnce offset={window.innerHeight}>
                                    ...
                                    <div className="form-row my-3">
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="indulasdate">{language === "eng" ? ("Departure day *") : ("Indulás napja *")}</label>
                                        ...
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="erkezesdate">{language === "eng" ? ("Date of arrival *") : ("Érkezés napja *")}</label>
                                ...
                                <ScrollAnimation animateIn="fadeIn" animateOnce offset={window.innerHeight}>
                                    <div className="form-row my-3">
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="seatsselect">{language === "eng" ? ("Seats *") : ("Férőhely *")}</label>
                                            <select className="form-control z-depth-1" name="ferohely"
                                                ...
                                                <option>{language === "eng" ? ("Please select...") : ("Kérjük válasszon...")}</option>
                                                <option value="1-8">1-8 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="9-17">9-17 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="18-21">18-21 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="22-28">22-28 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="29-34">29-34 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="35-48">35-48 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="49-51">49-51 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="52-56">52-56 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="57-59">57-59 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="60-68">60-68 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="69-70">69-70 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="71-74">71-74 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="75-78">75-78 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="79-80">79-80 {language === "eng" ? ("people") : ("fő")}</option>
                                                <option value="81-83">81-83 {language === "eng" ? ("people") : ("fő")}</option>
                                            </select>
                                        </MDBCol>
                                    </div>
                                </ScrollAnimation>
                                <ScrollAnimation animateIn="fadeIn" animateOnce offset={window.innerHeight}>
                                    <div className="form-row my-3">
                                        <MDBCol className="form-group px-md-3 px-2">
                                            <label htmlFor="comment">{language === "eng" ? ("Short description *") : ("Rövid leírás (hány nap, honnan/hova, utazás jellege) *")}</label>
                                            ...
                                            <div className="input-group z-depth-1">
                                                ...
                                                <div className="custom-file">
                                                    ...
                                                    <label className="custom-file-label" htmlFor="inputGroupFile01" data-browse={language === "eng" ? ("Browse") : ("Tallózás")}>
                                                        {language === "eng" ? ("Choose file") : ("Fájl csatolása")}</label>
                                                </div>
                                            </div>
                                        </MDBCol>
                                    </div>
                                ...
                                <ScrollAnimation animateIn="fadeInUp" animateOnce offset={window.innerHeight}>
                                    <MDBBtn color="dark" outline disabled={state.loading}
                                        ...
                                        ) : language === "eng" ? ("Get an offer") : ("Ajánlatot kérek")}</MDBBtn>
                                </ScrollAnimation>
                            </form>
                        </MDBCardBody>
                    </MDBCol>
